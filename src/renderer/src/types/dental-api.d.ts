...
export interface DatabaseApi {
  ...
  getAppointmentsByDateRange: (startDate: string, endDate: string) => Promise<AppointmentWithRelations[]>;
  ...
  createProcedure: (data: Omit<TreatmentProcedure, 'id' | 'createdAt' | 'updatedAt'>) => Promise<TreatmentProcedure>;
  updateProcedure: (id: number, data: Partial<TreatmentProcedure>) => Promise<TreatmentProcedure | undefined>;
