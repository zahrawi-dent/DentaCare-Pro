...
contextBridge.exposeInMainWorld('dentalApi', {
  ...
  getPatientWithAppointments: (id: number) =>
    ipcRenderer.invoke('db:patients:getWithAppointments', id),
  ...
  getDentistSchedule: (id: number, date: string) =>
    ipcRenderer.invoke('db:dentists:getSchedule', id, date),
  ...
  updateAppointment: (id: number, data: any) =>
    ipcRenderer.invoke('db:appointments:update', id, data),
  ...
  getProceduresByCategory: (category: string) =>
    ipcRenderer.invoke('db:procedures:getByCategory', category),
  ...
  getTreatmentsByPatient: (patientId: number) =>
    ipcRenderer.invoke('db:treatments:getByPatient', patientId),
  getTreatmentsByStatus: (status: string) =>
    ipcRenderer.invoke('db:treatments:getByStatus', status),
